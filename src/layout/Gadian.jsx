...
import gradianLogo from '../assets/gradian/gradianLogo.jpg';
...
function Gradian() {
  const getGradian = DataCenter.filter(
    (gradian) => gradian.storeID === 'gradian',
  );
  ...
  // product count
  const ProductCount = getGradian.length;
          ...
          {getGradian.slice(0, 4).map((phka) => (
            ...
            >
              ...
              <div className="h-full pl-2.5 pt-2.5 ">
                <h1 className="text-lg font-medium truncate">{phka.title}</h1>

import medicubelogo from '../assets/medicube/medicubelogo.webp';
import product1 from '../assets/medicube/medicubelogo.webp';
  ...
  const AnuaCollection = [
    {
      id: 'medicube001',
      fullPrice: 14.99,
      title: 'Medicube - Retinol 0.3 Niacin',
      discountPercent: 12,
      src: product1,
      alt: 'Medicube - Retinol 0.3 Niacin',
      sold: 786,
      ratting: 4.5,
      stock: 200,
      deliveryStatus: true,
    ...
    },
    {
      id: 'medicube002',
      fullPrice: 18.67,
      title: 'Medicube - Peach 70 serum',
      discountPercent: 12,
      src: product1,
      alt: 'Medicube - Peach 70 serum',
      sold: 12040,
      ratting: 4.5,
      stock: 200,
      deliveryStatus: true,
    ...
    },
    {
      id: 'medicube003',
      fullPrice: 12.67,
      title: 'Medicube - Rice ceramide hydrating barrier serum',
      discountPercent: 12,
      src: product1,
      alt: 'Medicube - Rice ceramide hydrating barrier serum',
      sold: 1090,
      ratting: 5,
      stock: 200,
      deliveryStatus: true,
    ...
    },
    {
      id: 'medicube004',
      fullPrice: 36.87,
      title: 'Medicube - Essential bestsell kit',
      discountPercent: 12,
      src: product1,
      alt: 'Medicube - Essential bestsell kit',
      sold: 5000,
      ratting: 4,
      stock: 200,
      deliveryStatus: true,

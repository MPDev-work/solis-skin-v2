...
import PhkaLogo from '../assets/Phka/phkalogo.jpg';
import BlueTick from '../assets/blue-checkmark-validation-social-media-png.png';
import { DataCenter } from '../data/DataCenter';
import { Fragment } from 'react';
import PhkaBanner from '../assets/Phka/phkabanner.webp';
function PhkaMainPage() {
  const getPhka = DataCenter.filter((pkha) => pkha.storeID === 'phka');
          ...
          {getPhka.map((phka) => (
            ...
            >
              ...
              <div className="h-full pl-2.5 pt-2.5 ">
                ...
                {/* way to get size indide nested array */}
                {/* <div className="h-max w-max flex flex-row justify-start items-center gap-2 py-0.5 px-1.5 bg-[#f2f2f6] rounded-full mt-1">
                  {phka.availableSize.map((size) => {
                    return <span className="text-[10px]">{size}ml</span>;
                  })}
                </div> */}
